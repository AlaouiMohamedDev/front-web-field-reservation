...
const Fields = ({fields}) => {
    ...
    const [displayedFields, setDisplayedFields] = useState(fields)
    useEffect(() => {
    ...
    return (
        ...
        <div className="flex items-center justify-between py-5 ">
            <h1 className="font-bold custBlue text-lg">Fields</h1>
                                    ...
                                    <tr key={key} className="border-b dark:border-neutral-500">
                                        <td className="whitespace-nowrap px-6 py-4 font-medium flex items-center space-x-2">
                                            <input
                                                ...
                                                value=""
                                                id={item.id} />
                                                <img src={item.terrain_photo} alt="user" className="w-8 h-8 rounded-full object-cover" />
                                               
                                        </td>
                                        <td className="whitespace-nowrap px-6 py-4 ">
                                            <span className="text-[9px] text-gray-600">#CMP{item.id}</span>
                                            <p className="text-sm font-semibold">{item.Fieldname}</p>
                                        </td>
