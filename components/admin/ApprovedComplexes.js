...
export default function ApprovedComplexes({complexs}) {
  ...
  return (
    ...
    <div className="flex items-center justify-between">
        <h1 className="text-custBlue font-semibold">List approved complexes</h1>
                ...
                <tbody>
                    {
                        displayedComplexs.filter((val)=>{
                            ...
                            <tr key={key} className="border-b dark:border-neutral-500">
                                ...
                                <td className="whitespace-nowrap px-6 py-4 text-main flex items-center  text-xs  space-x-1">
